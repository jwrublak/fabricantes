...
class FabricantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fabricante" do
    assert_difference('Fabricante.count') do
      post fabricantes_url, params: { fabricante: { codigo: @fabricante.codigo, nome: @fabricante.nome } }
    end
  ...
  test "should update fabricante" do
    patch fabricante_url(@fabricante), params: { fabricante: { codigo: @fabricante.codigo, nome: @fabricante.nome } }
